...
public class Main {
    ...
    // adjust file path to your own path. Below is an example for macs. Otherwise
    // use C:\Users\name\Documents\CPSC_Courses\MP4\Medicines.csv
    // for windows example -
    // C:\\Users\\Name\\Documents\\CPSC_Courses\\CPSC_231\\MP4\\Medicines.csv
                ...
                if (input <= 3) {
                    if (input > 1) {
                        ...
                        if (key.equals(MASTER_KEY)) {
                            System.out.println(
                                    "To create your account we will need your name and a password to keep your account secure.");
                        ...
                        try {
                            ...
                            System.out.println(
                                    "There are no doctors at this time, please come back and register at a later date");
                        }
                    }
                } else if (input == 0) {
                    break;
