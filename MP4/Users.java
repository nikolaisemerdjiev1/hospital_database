...
public class Users {
    ...
    private static final List<String> DRUG_INTERACTIONS = Arrays.asList(
            "Warfarin", "Ibuprofen", "Naproxen", "Alcohol", "Aliskiren", "Lithium", "Grapefruit juice", "Amiodarone",
            "CNS depressants", "Clopidogrel", "Ketoconazole", "Cimetidine", "Furosemide", "Probenecid", "Methotrexate",
            "Cyclosporine", "MAOIs", "Rivaroxaban", "Procainamide", "Calcium supplements", "Antacids",
            "Bleeding disorders", "NSAIDs", "Sertraline", "Lisinopril", "Verapamil", "Thioridazine",
            "Potassium supplements", "Pimozide", "Morphine", "Nitrates", "Riociguat", "Simvastatin", "Theophylline",
            "Carbamazepine", "Doxazosin", "Ritonavir", "Serotonin reuptake inhibitors", "Clopidogrel", "Digoxin",
            "Aspirin", "Ciprofloxacin", "Statins", "NSAIDs", "Oxycodone", "None");
    ...
    public void getAccess() {
        try {
            ...
            System.out.println(
                    "Sorry either you dont have an account with us or entered your name wrong\nIf issue persists please contact your doctor");
        }
    }
            ...
            while (!input.equals("q")) {
                ...
                if (input.equals("q")) {
                    ...
                    if (input2.equals("y")) {
                        ...
                        String drugInteractions = DRUG_INTERACTIONS.get(index2) + ";"
                                + DRUG_INTERACTIONS.get(index2 - 1);
                        new OverTheCounter(Main.lastID() + 1, name, expires, CHEMICAL_COMPOUNDS.get(index),
                                drugInteractions).addMedicine();
                        ...
                        String drugInteractions = DRUG_INTERACTIONS.get(index2) + ";"
                                + DRUG_INTERACTIONS.get(index2 - 1);
                        new Prescription(Main.lastID() + 1, name, expires, CHEMICAL_COMPOUNDS.get(index),
                                drugInteractions).addMedicine();
                    }
